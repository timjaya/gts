vec_selector_i <- function(.data, select_vars) {
  ...
  integer_cols <- list(is.integer = seq_along(data_names)[map_lgl(.data, is.integer)])
  double_cols <- list(is.double = seq_along(data_names)[map_lgl(.data, is.double)])
  numeric_cols <- list(is.numeric = seq_along(data_names)[map_lgl(.data, is.numeric)])
  character_cols <- list(is.character = seq_along(data_names)[map_lgl(.data, is.character)])
  factor_cols <- list(is.factor = seq_along(data_names)[map_lgl(.data, is.factor)])
  logical_cols <- list(is.logical = seq_along(data_names)[map_lgl(.data, is.logical)])
